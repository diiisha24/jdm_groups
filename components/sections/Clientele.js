...
//         { name: "Electronics", logos: Array.from({ length: 33 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Sector_Wise/Electronics/${i + 1}.png`, alt: `Construction Logo ${i + 1}` })) },
...
const Clientele = () => {
  const [activeTab, setActiveTab] = useState("sector");
  const [activeSector, setActiveSector] = useState("Agriculture");
  const [activeCountry, setActiveCountry] = useState("India"); // Default country
  const [sectorLogos, setSectorLogos] = useState([]);
  ...
  useEffect(() => {
    const fetchStaticData = () => {
      ...
      const countries = [
        { name: "India", logos: Array.from({ length: 147 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/India/${i + 1}.png`, alt: `India Logo ${i + 1}` })) },
        { name: "China", logos: Array.from({ length: 5 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/China/${i + 1}.png`, alt: `China Logo ${i + 1}` })) },
        { name: "Europe", logos: Array.from({ length: 10 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Europe/${i + 1}.png`, alt: `Europe Logo ${i + 1}` })) },
        { name: "Germany", logos: Array.from({ length: 8 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Germany/${i + 1}.png`, alt: `Germany Logo ${i + 1}` })) },
        { name: "Italy", logos: Array.from({ length: 4 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Italy/${i + 1}.png`, alt: `Italy Logo ${i + 1}` })) },
        { name: "Japan", logos: Array.from({ length: 11 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Japan/${i + 1}.png`, alt: `Japan Logo ${i + 1}` })) },
        { name: "Singapore", logos: Array.from({ length: 2 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Singapore/${i + 1}.png`, alt: `Singapore Logo ${i + 1}` })) },
        { name: "South Korea", logos: Array.from({ length: 3 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/South Korea/${i + 1}.png`, alt: `South Korea Logo ${i + 1}` })) },
        { name: "Taiwan", logos: Array.from({ length: 1 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/Taiwan/${i + 1}.png`, alt: `Taiwan Logo ${i + 1}` })) },
        { name: "UK", logos: Array.from({ length: 4 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/UK/${i + 1}.png`, alt: `UK Logo ${i + 1}` })) },
        { name: "United States", logos: Array.from({ length: 15 }, (_, i) => ({ id: i, src: `/assets/img/customer_logo/Country_Wise/United States/${i + 1}.png`, alt: `United States Logo ${i + 1}` })) },
      ];
  ...
  const selectedSectorLogos = sectorLogos.find((sector) => sector.name === activeSector)?.logos || [];
  const selectedCountryLogos = countryLogos.find((country) => country.name === activeCountry)?.logos || [];
            ...
            <div className="sector-container">
              <ul className="sector-nav">
                {countryLogos.map((country) => (
                  ...
                  >
                    <button onClick={() => handleCountryChange(country.name)}>
                      {country.name}
                    </button>
                  </li>
                ))}
              ...
              <div className="sector-content">
                {isLoading ? (
                  ...
                  <>
                    ...
                    {selectedCountryLogos.length > 0 ? (
                      <div className="logo-grid">
                        {selectedCountryLogos.map((logo) => (
                          <div key={logo.id} className="grid-item">
                            <div className="brand-image center">
                              <img
                                src={logo.src}
                      ...
                      <p>No logos available for this country.</p>
                    )}
                  </>
                )}
              </div>
