  ...
  const tabs = [
    ...
    },
    {
      ...
      content: (
        <>
          <p>
          Special Economic Zones SEZ/STPI are growth engines that can boost manufacturing, augment expoerts and generate employment, The SEZs require special fiscal and regulatory regime in order to import a hassle free operation encompassing the sate of the art infrastructure and support services, JDM is the pioneer in setting up SEZ/STPI units in Economics Zones. Well versed with the intricacies of the SEZ/STPI rules, we stand tall in providing single window solutions to all these units by handling government regulatory authorities such as SEZ/STPI excise and customs.
          </p>
        </>
      ),
    },
