...
const defaultServices = [
  ...
  },
  {
    ...
    benefits: ["Advance Authorization", "Special Valuation Branch (SVB)", "Refund of Extra Duty Deposit (EDD)", "Authorized Economic Operator (AEO)", "Export Promotion Capital Goods (EPCG)", "Import of Goods at Concessional Rate of Duty (IGCR)", "Matters related to Directorate General of Foreign Trade (DGFT)", "Manufacturing and Other Operations in a Warehouse Rules (MOOWR)"],
  },
  {
    id: "courier-services",
